...
const RestaurantCard = ({
  ...
  return (
    <div className="flex border-b md:border-b-0 shadow-xl md:shadow-sm justify-between md:flex-col my-3 md:m-6 bg-white w-full  md:w-48 hover:scale-110 transition duration-300 ease-in-out hover:rounded-md">
      <div className="md:rounded-t-2xl border-r flex md:flex-col md:rounded-b-xl md:shadow-lg">
        ...
        />
        <div>
          <h2 className="md:text-lg font-semibold p-2 w-32 md:w-full overflow-hidden text-ellipsis whitespace-nowrap">
            {name}
          </h2>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center md:p-2 md:border-t">
        <h1 className="text-ellipsis text-center text-sm">{sla.slaString}</h1>
